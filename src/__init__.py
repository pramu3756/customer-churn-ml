...
def generate_synthetic_telco_churn_data(n_samples: int = 5000, random_state: int = 42) -> pd.DataFrame:
    """Generates realistic synthetic Telco customer churn dataset."""
    ...
    # Calculate churn probability based on risk heuristics
    churn_prob = (
...
if __name__ == "__main__":
    ...
    dataset = generate_synthetic_telco_churn_data()
    dataset.to_csv("data/raw/telco_churn_raw.csv", index=False)
    print("Generated dataset saved to data/raw/telco_churn_raw.csv")
